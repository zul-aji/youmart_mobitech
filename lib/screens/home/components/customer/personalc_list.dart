...
class PersonalCList extends StatelessWidget {
  final productController = Get.put(ProductController());

  PersonalCList({Key? key}) : super(key: key);
    ...
    return Obx(
      () => Flexible(
        child: GridView.builder(
            ...
            itemCount: productController.personalProduct.length,
...
class CatalogProductCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final productData = productController.personalProduct[index];
    return Padding(
